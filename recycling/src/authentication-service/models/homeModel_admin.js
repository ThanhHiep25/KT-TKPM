...
import FrameHomeAdmin from "./frameHome_admin";
import ReportingModelAdmin from "../../reporting-service/models/reportingModel_admin";

function HomeModelAdmin() {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {user ? user.name : 'Guest'} - {user ? user.role : "Tester"}
          </p>
        </div>
          ...
          >
            ...
            >
              <div className="menu-item">
                ...
                <p className="p-home">Yêu cầu tái chế thiết bị</p>
              </div>
            </li>
            <li
            ...
            >
              <div className="menu-item">
                ...
                <p className="p-home">Phản hổi đánh giá thiết bị</p>
              </div>
            </li>
          </ul>
        </div>
